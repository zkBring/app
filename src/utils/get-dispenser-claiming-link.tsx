...
type TGetDispenserClaimintLink = (
...
const getDispenserClaimingLink: TGetDispenserClaimintLink = async (
  multiscanSecret,
  multiscanQREncCode
) => {
  try {
...
export default  getDispenserClaimingLink

function errorCallback(arg0: string) {
